...
let contractAddress = 'TLWQiEnEyHBG1X37dfLmYoSYcHNuVdW3Ac';
let serverUrl = 'https://arcane-spire-90140.herokuapp.com/';
let tronScan = 'https://tronscan.org/#/contract/TLWQiEnEyHBG1X37dfLmYoSYcHNuVdW3Ac/transactions';
...
$(document).ready(async () => {
  ...
  if (window.location.hostname == '127.0.0.1' || params.has('testing')) {
    contractAddress = 'TLWQiEnEyHBG1X37dfLmYoSYcHNuVdW3Ac';
  }
