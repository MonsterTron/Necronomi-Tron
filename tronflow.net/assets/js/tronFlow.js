...
let tronScan = 'https://tronscan.org/#/contract/TVuYBLiDUYof2XENqo74bq2SPP9qVVm2yt/transactions';
...
$(document).ready(async () => {
  ...
  if (window.location.hostname == '127.0.0.1' || params.has('testing')) {
    contractAddress = 'TVuYBLiDUYof2XENqo74bq2SPP9qVVm2yt';
  }
...
let invester = await contract.players(currentAccount).call();
 ...
 // hex_address = tronWeb.address.toHex(address);
  if (sponsoraddress == 'TVuYBLiDUYof2XENqo74bq2SPP9qVVm2yt'){
